...
const CONFIG = {
    introTitle: '🖐🖐🖐 Hee loo Duyên ! 🖐🖐🖐',
    introDesc: `Tao có câu này hỏi mày nè😅 `,
    btnIntro: 'OK',
    title: 'Mày có muốn nhận quà sinh nhật không nè ? 😙',
    desc: 'Không cần ngại đâu nha :> ',
    btnYes: 'Thôi, không cần đâu😝',
    btnNo: 'Cóa, cần chứ 😍',
